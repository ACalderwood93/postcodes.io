...
const { Postcode, TerminatedPostcode } = require("../../src/app/models/index");
...
const isRawPostcodeObjectWithFC = (o, additionalAttr, blacklist) => {
  isRawPostcodeObject(
    o,
    Postcode.getForeignColNames().concat(additionalAttr || []),
    blacklist
  );
};

const isRawPostcodeObjectWithFCandDistance = (o) =>
